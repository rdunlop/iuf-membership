...
Rollbar.configure do |config|
  ...
  config.js_options = {
    accessToken: Rails.configuration.rollbar_client_access_token,
    captureUncaught: true,
    payload: {
      environment: Rails.configuration.rollbar_env
    }
  }
  ...
  config.environment = Rails.configuration.rollbar_env
end
